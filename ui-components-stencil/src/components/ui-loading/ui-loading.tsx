...
export class UiLoading {
  ...
  render() {
    return (
      <div tabindex="-1" aria-hidden="true" class="backdrop-blur-sm bg-white/60 overflow-y-auto overflow-x-hidden absolute top-0 bottom-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
